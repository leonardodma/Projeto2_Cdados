...
- Separamos a coluna "Resultado" em uma outra variável, porque seria mais fácil trabalhar com ela separadamente depois, já que é a nossa base de comparação com as outras variáveis;
- 
